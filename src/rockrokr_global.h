...
#define MAIN_WINDOW_H                       dpi_to_px(800)
...
#define PLAY_BAR_BIG_BTN_W                  dpi_to_px(70)
...
#define MAIN_VIEW_FONT_SIZE_TITLE           dpi_to_px(32)
#define MAIN_VIEW_FONT_SIZE_PRIMARY         dpi_to_px(12)
#define MAIN_VIEW_FONT_SIZE_SECONDARY       dpi_to_px(10)
#define MAIN_VIEW_TITLE_BAR_H               dpi_to_px(32) //maybe bigger than MAIN_VIEW_FONT_SIZE_TITLE
...
#define MAIN_VIEW_LISTITEM_CONTENT_MARGIN   dpi_to_px(9)  //margin for content in listitem
...
#define MAIN_VIEW_LISTITEM_LEFT_CONTENT_W   dpi_to_px(170) //160 OR 150
#define MAIN_VIEW_LISTITEM_MIDDLE_CONTENT_W dpi_to_px(160)
#define MAIN_VIEW_LISTITEM_RIGHT_CONTENT_W  dpi_to_px(40) //or less?

// horizontal listview
#define MAIN_VIEW_COVER_ITEM_MARGIN         dpi_to_px(14) //margin for horizontal listitems
#define MAIN_VIEW_COVER_ITEM_CONTENT_MARGIN dpi_to_px(6) // (154-142)/2
#define MAIN_VIEW_COVER_W                   dpi_to_px(154)
#define MAIN_VIEW_COVER_H                   dpi_to_px(190)
#define MAIN_VIEW_COVER_ICON_W              dpi_to_px(142)
#define MAIN_VIEW_COVER_ICON_H              MAIN_VIEW_COVER_ICON_W
#define MAIN_VIEW_COVER_FONT_SIZE_PRIMARY   dpi_to_px(14)
#define MAIN_VIEW_COVER_FONT_SIZE_SECONDARY dpi_to_px(10)
/*
 * end main view
 */
...
class QSize;
///
/// \brief svgToPixmap render svg to pixmap
/// \param svg
/// \param targetSize
/// \param pixmap
/// \return true if load to pixmap succesful
///
